...
export const allAccessRoles = [RolesEnum.ADMIN, RolesEnum.PROJECTMANAGER, RolesEnum.HRMANAGER, RolesEnum.EMPLOYEE];
export const employeeAccessRole = [RolesEnum.ADMIN, RolesEnum.EMPLOYEE];
export const hrManagerAccessRoles = [RolesEnum.ADMIN, RolesEnum.HRMANAGER];
...
export const allowedRolesForUpdateArray = (loggedInUser?: IAuthUser): string[] => {
  return loggedInUser?.roles.includes(RolesEnum.ADMIN)
    ? [RolesEnum.PROJECTMANAGER, RolesEnum.HRMANAGER, RolesEnum.EMPLOYEE]
    : [];
};
